...
la_chi, nhanlachi = extract_hog_features_from_folder(       r"E:/Downloads/DATA/LEAF/THAIDUCTOAN/la_chi", 1, output_gray_folder=output_gray_folder)                  #lachi
...
la_tao, nhanlatao = extract_hog_features_from_folder(       r"E:/Downloads/DATA/LEAF/NGOHUUMINH/la tao", 4, output_gray_folder=output_gray_folder)                                       #la tao
